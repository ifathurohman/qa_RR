...
$(document).ready(function() { 
  if($("input").hasClass("autocomplete_pengajuan_kpr")){
    autocomplete_pengajuan_kpr(".autocomplete_pengajuan_kpr");
  }
  if($("input").hasClass("autocomplete_marketing")){
    autocomplete_marketing(".autocomplete_marketing");
  }
  if($("input").hasClass("autocomplete_pemesanan")){
    autocomplete_pemesanan(".autocomplete_pemesanan");
  }
});
