...
var url_list    = host + "contact/ajax_list/";
var url_edit    = host + "contact/edit/";
var url_hapus   = host + "contact/delete/";
var url_active  = host + "contact/active/";
var url_simpan  = host + "contact/save";
var url_update  = host + "contact/update";
...
function edit(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            v = data.data;
            $('[name="ContactID"]').val(v.ContactID);
            $('[name="Name"]').val(v.Name);
            $('[name="Company"]').val(v.Company);
            $('[name="Email"]').val(v.Email);
            $('[name="Contact"]').val(v.Contact);
            $('[name="Subject"]').val(v.Subject);
            $('[name="Message"]').val(v.Message);
