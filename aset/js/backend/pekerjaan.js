...
var url_list    = host + "status_pekerjaan/ajax_list/";
var url_hapus   = host + "status_pekerjaan/delete/";
var url_active  = host + "status_pekerjaan/active/";
var url_simpan  = host + "status_pekerjaan/save";
var url_edit    = host + "status_pekerjaan/edit/";
var url_update  = host + "status_pekerjaan/update/";
...
function edit(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('[name="Color"]').val(v.Color);
            $('[name="WorkStatusOrder"]').val(v.WorkStatusOrder);
